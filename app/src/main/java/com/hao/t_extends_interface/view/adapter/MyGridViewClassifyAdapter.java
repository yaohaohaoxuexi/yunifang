...
public class MyGridViewClassifyAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<BeanClassify.DataBean.GoodsBriefBean> list;

    public MyGridViewClassifyAdapter(Context context, ArrayList<BeanClassify.DataBean.GoodsBriefBean> list) {
